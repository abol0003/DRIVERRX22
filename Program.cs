                ...
                default:
                    ...
                    switch (cmd)
                    {
                        ...
                        case 0x04: // JoinDevice
                            ...
                            for (int i = 0; i < 16; i++) icp2[3 + i] = (byte)(0x77 + i);
                            icp2[3 + 16] = 0x03;
                            break;
                        case 0x0A: // QueryState
                            icp2 = new byte[8];
                            icp2[0] = 0x00; // handle high
                            icp2[1] = 0x00; // handle low
                            icp2[2] = 0x00; // status = SUCCESS
                            icp2[3] = 0x01; // example mode
                                            // example state bytes
                            icp2[4] = 0x11;
                            icp2[5] = 0x22;
                            icp2[6] = 0x33;
                        ...
                        case 0x09: // ChangeState
                            byte mode = payload[33];
                            byte[] state = payload.Skip(34).Take(4).ToArray();
                            icp2 = new byte[8];
                            icp2[0] = 0x00;         
                            icp2[1] = 0x00;       
                            icp2[2] = 0x00;     
                            icp2[3] = mode;       
                            Array.Copy(state, 0, icp2, 4, 4);  
                            break;
                        case 0x0B: // LearnControl
                            byte modeLc = payload[34];
                            byte[] stateLc = payload.Skip(35).Take(4).ToArray();
                            icp2 = new byte[8];
                            icp2[0] = 0x00;
                            icp2[1] = 0x00;
                            icp2[2] = 0x00;
                            icp2[3] = modeLc;
                            Array.Copy(stateLc, 0, icp2, 4, 4);
                            break;
                        case 0x07: // AddFilter
